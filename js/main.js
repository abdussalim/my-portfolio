...
const translations = {
  id: {
    ...
    'hero.title': 'Saya masak sistem kalem, lalu saya sajikan rapi.',
    ...
    'photos.portfolio': 'Buka jejak portfolio',
  ...
  en: {
    ...
    'photos.card2': 'Quiet build time',
    'photos.card3': 'Ordinary archive',
    'photos.portfolio': 'Open portfolio links',
...
const japaneseTranslations = {
  ...
  'photos.portfolio': 'ポートフォリオリンクを開く',
